...
Storage.bg = {
	...
	loadHues: function (hues) {
		...
		for (var i = 0; i < 5; i++) {
			var n = i + 1;
			var hs = hues[i];
			cssBuf += 'body .button.mainmenu' + n + ' { background: hsl('+hs+',72%); }\n';
			cssBuf += 'body .button.mainmenu' + n + ':hover { background: hsl('+hs+',62%); }\n';
			cssBuf += 'body .button.mainmenu' + n + ':active { background: hsl('+hs+',42%); }\n';
		}
